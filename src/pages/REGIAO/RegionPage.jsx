                ...
                {region && (
                    <section className="region-page__content" aria-label={`Conteúdos da região ${region.name}`}>
                        <div className="region-content">
                            <h2 className="region-content__title">
                                Conteúdos da região {region.name}
                            </h2>

                            {!isConfigured ? (
                                <p className="region-content__text">
                                    Configuração do Google Drive ausente para esta região.
                                </p>
                            ) : (
                                <>
                                    ...
                                    {loading && (
                                        <div className="region-content__loading">
                                            Carregando conteúdos da região...
                                        </div>
                                    )}
                                    
                                    {error && (
                                        <div className="region-content__error">{error}</div>
                                    )}
