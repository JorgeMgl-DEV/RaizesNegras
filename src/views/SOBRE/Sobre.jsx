      ...
      <main className="sobre__main">
        <section className="sobre__section">
          ...
          <p className="sobre__text">
            Raízes Negras é um acervo digital dedicado a reunir e dar visibilidade a referências, artigos e registros sobre a cultura negra, com navegação por regiões e conteúdos temáticos. O projeto busca facilitar o acesso ao conhecimento, apoiar pesquisas e iniciativas educacionais, e fortalecer a valorização da memória e da produção cultural.
          </p>
          ...
          <p className="sobre__text sobre__text--spaced">
            Tecnologias: aplicação em React com Next.js e integração com serviços em nuvem para facilitar a busca e a curadoria de materiais.
          </p>
        </section>
        ...
        <section>
          ...
          <article className="sobre__card">
            <div className="sobre__photo" aria-label="foto Jorge">
              <Image src={fotoJorge} alt="Foto de Jorge Miguel Viana Torres" className="sobre__img" width={320} height={320} />
            </div>
            <div>
          ...
          <article className="sobre__card">
            <div className="sobre__photo" aria-label="foto Erick">
              <Image src={fotoErick} alt="Foto de Erick MacGregor" className="sobre__img" width={320} height={320} />
            </div>
            <div>
          ...
          <article className="sobre__card sobre__card--last">
            <div className="sobre__photo" aria-label="foto Murilo">
              <Image src={fotoMurilo} alt="Foto de Murilo Gabriel Mourão" className="sobre__img" width={320} height={320} />
            </div>
            <div>
